...
units = {  # type: UnitDict
    ...
    'fluid_ounce_us': Unit('fluid ounce', 'fluid ounces', 'fl oz', Decimal(480), us_minim_to_liter),
    'shot_us': Unit('shot', 'shots', 'jig', Decimal('1.5') * _ounce_minim_multiple,
                    us_minim_to_liter),
    'gill_us': Unit('gill', 'gills', 'gil', Decimal(4) * _ounce_minim_multiple, us_minim_to_liter),
    'cup_us': Unit('cup', 'cups', 'c', Decimal(8) * _ounce_minim_multiple, us_minim_to_liter),
    'pint_us': Unit('pint', 'pints', 'pt', Decimal(16) * _ounce_minim_multiple, us_minim_to_liter),
    'quart_us': Unit('quart', 'quarts', 'qt', Decimal(32) * _ounce_minim_multiple,
                     us_minim_to_liter),
    'gallon_us': Unit('gallon', 'gallons', 'gal', Decimal(128) * _ounce_minim_multiple,
                      us_minim_to_liter),
    'barrel_us': Unit('barrel', 'barrels', 'bbl',
                      Decimal('31.5') * Decimal(128) * _ounce_minim_multiple, us_minim_to_liter),
}
